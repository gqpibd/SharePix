...
<body class="mbody">
			...
			if (reList != null) {
				...
				<%} else { // 댓글 표시
					...
					<div class="tooltip" align="right">
						<img src="images/icons/more.png" width="3px" align="right"
							class="more"> <span class="tooltiptext"> <label
							onclick="modify('<%=re.getReSeq()%>')" id="<%=re.getReSeq()%>"
							class="aTg">수정</label><br> <label
							onclick="deleteReply(<%=re.getReSeq()%>)" class="aTag">삭제</label><br>
						</span>
					</div> 
					<%}%>
	...
	<section class="rightbar">
		<div style="margin: 10px">
			<p>
				<img src="images/profiles/<%=pds.getId()%>.png" width="100"	class="profile" align="middle"> <!-- 작성자의 프로필 사진 -->
				<%=pds.getId()%>
			</p>
