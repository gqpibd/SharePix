...
<body>
	...
	<div align="center" style="margin-top: 10em">
		<form action="PdsController" method="get" id="pdsupdate">
			<input type="hidden" name="command" value="pdsupdate"> <input
			...
			<table border="1" bgcolor="white"
				...
				<tr>
					<td align="center"><img
						src="images/pictures/<%=dto.getfSaveName() %>" width="500">
					</td>
					<td border="1"><select name="category">
					...
					<br>
						<div style="position: relative; float: left; text-align: left;">
							<textarea rows="2" cols="20" name="tags">
								<%for(int i=0;i<dto.getTags().length;i++){ %>#<%=dto.getTags()[i]%>
								<%}%>
							</textarea>
						</div></td>
				</tr>
